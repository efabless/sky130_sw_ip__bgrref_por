...
C {devices/capa.sym} 700 -120 0 0 {name=C1
m=1
value=20p
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 700 -150 0 1 {name=p12 lab=por}
C {devices/capa.sym} 600 -120 0 0 {name=C2
m=1
value=20p
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 600 -150 0 1 {name=p19 lab=porb}
C {devices/gnd.sym} 600 -90 0 0 {name=l4 lab=GND}
C {devices/gnd.sym} 700 -90 0 0 {name=l7 lab=GND}
