...
C {devices/code.sym} 830 -430 0 0 {name=TT_MODELS
only_toplevel=true
...
C {devices/code.sym} 830 -250 0 0 {name=ngspice only_toplevel=false value="
...
C {devices/vsource.sym} 50 -300 0 0 {name=V6 value="PULSE 0 1.8 10n 0.5m 1m 200mm 400m"}
