...
C {devices/vsource.sym} 200 -470 0 0 {name=Vavdd value="PULSE 0 3.3 10n 1m 1m 0.2m 2.4m"}
...
C {devices/code.sym} 790 -230 0 0 {name=ngspice only_toplevel=false value="
...
.endc
"}
C {devices/code.sym} 770 -430 0 0 {name=TT_MODELS
only_toplevel=true
spice_ignore=false
