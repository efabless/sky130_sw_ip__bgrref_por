...
C {ammeter.sym} 290 -710 0 0 {name=Vrbranch savecurrent=true lvs_short=true}
C {ammeter.sym} 460 -460 3 0 {name=Vcomp savecurrent=true lvs_short=true}
C {ammeter.sym} 690 -390 3 0 {name=Vpulse savecurrent=true lvs_short=true}
