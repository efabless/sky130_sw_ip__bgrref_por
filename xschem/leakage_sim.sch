...
C {devices/lab_wire.sym} 720 -160 0 1 {name=p12 lab=por}
C {devices/capa.sym} 620 -130 0 0 {name=C2
m=1
value=20p
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 620 -160 0 1 {name=p19 lab=porb}
C {devices/gnd.sym} 620 -100 0 0 {name=l4 lab=GND}
C {devices/gnd.sym} 720 -100 0 0 {name=l7 lab=GND}
